...
public class LinePayService {
	 ...
	 public ResponseEntity<Object> setupLinePay() throws JSONException {
	        ...
	        // 创建LinePay请求的数据对象
	        LinePayObject linePayRequest = new LinePayObject(1, "TWD", "MyProd", "https://cimg.cnyes.cool/prod/news/4556115/l/79b7b76238dcaa28d626ec007bff576f.jpg", "http://localhost:8080/gymlife/confirm", "Order202203110011");
	        // 设置请求的data JSON
	        JSONObject requestData= new JSONObject();
	        requestData.put("amount", linePayRequest.getAmount());
	        requestData.put("currency", linePayRequest.getCurrency());
	        requestData.put("productName", linePayRequest.getProductName());
	        ...
	        ResponseEntity<String> responseEntity = restTemplate.exchange("https://api-pay.line.me/v2/payments/request", HttpMethod.POST, requestEntity, String.class);
